  ...
  <div>
    ...
    <md-content class="top">
      <div class="background-image">
        ...
        <img
          v-if=" $store.state.userBackground || user.background_image"
          :src="$store.state.userBackground ? $store.state.userBackground : user.background_image"
          alt="background image"
        >

        <div v-if="sameUser" class="edit-background-image">
          <input type="file" id="file1" ref="file1"  @change="handleFileUpload('background_image')"/>
      ...
      <div class="user-image">
        ...
        <img v-if="$store.state.userImage || user.picture " :src="$store.state.userImage ? $store.state.userImage : user.picture" :alt="'image of ' + user.name" v-bind:title="'image of ' + user.name" class="img-raised" >
        <img v-else src="/images/avatar.png" :alt="'image of ' + user.name" v-bind:title="'image of ' + user.name" class="img-raised" >

        <div v-if="sameUser" class="edit-picture">
          <input type="file" id="file2" ref="file2" v-on:change="handleFileUpload('picture')"/>
...
export default {
  ...
  mounted() {
    ...
    // this.$store.commit('SET_PROFILE', this.user.picture, this.user.background_image)
  },
  methods: {
    isSameUser() {
    ...
    submitFile(fieldName) {
      ...
      axios
        .post(
          "https://ed808.com:92/latin/file?parameter[hash]=020042f70a981fd6806ecf5e53f2267b377da9d9f981e15297d70c3f7c2a87d0",
          formData,
          {
            headers: {
    ...
    doneEditingThis(fieldName) {
      ...
      axios
        .put(
          "https://ed808.com:92/latin/user/" + this.$route.params.uid,
          data,
          {
            headers: {
    ...
    afterfieldsaved(fieldName, data) {
      ...
      if (
        fieldName == "work" &&
        Object.keys(this.afterUpload["cv"]).length > 0
      ) {
    ...
    createData(fieldName) {
      ...
      if (fieldName == "education") {
        data = {
          hash:
            "50e185c2e0c2bc30215338db776022c92ecbc441fd933688c6bf4f274c863c60",
